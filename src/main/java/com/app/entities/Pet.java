...
public class Pet {
	...
	/*
	 * @Override public String toString() { return "Pet [pet_id=" + pet_id +
	 * ", pet_name=" + pet_name + ", pet_type=" + pet_type + ", pickupDate=" +
	 * pickupDate + ", deliveryDate=" + deliveryDate + ", about_pet=" + about_pet +
	 * ", image=" + image + ", user=" + user + ", room=" + room + "]"; }
	 */
