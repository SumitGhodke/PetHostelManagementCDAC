...
public class HomeCotroller {
	...
	/* handler for showing all the user */
	...
	/* handler for deleting user as per id */
	...
	/* handler showing all pets which are boarded by user */
	@RequestMapping("/allPets")
	public String getAllPets(Model model) {

		List<Pet> pets = this.petRepository.findAll();
		System.out.println("Room id from admin controller" + pets);
	...
	/* Handler for assigning staff to boarded pet */
	/*
	...
	public String loginFail(Model model, HttpSession httpSession) {
		model.addAttribute("title", "Login failed");
		httpSession.setAttribute("message", new Message("username or password is  incorrect", "danger"));
		return "login";
	}

	/* Without using form setting default value to modal */
	/*
